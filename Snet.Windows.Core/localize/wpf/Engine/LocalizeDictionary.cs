...
namespace Snet.Windows.Core.localize.wpf.Engine
{
    ...
    #region Usings
    using Snet.Windows.Core.localize.wpf.Extensions;
    using Snet.Windows.Core.localize.wpf.Providers;
    using System;
...
#pragma warning restore IDE0060
        ...
        #region Constructor
        /// <summary>
        /// Prevents a default instance of the <see cref="T:Snet.Windows.Core.localize.wpf.Engine.LocalizeDictionary" /> class from being created.
        /// Static Constructor
        /// </summary>
